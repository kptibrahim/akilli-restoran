        ...
        <div className="rounded-2xl p-7 space-y-5"
          ...
          {gonderildi ? (
            <div className="text-center py-4 space-y-4">
              ...
              <p className="font-bold" style={{ color: "#F5E6C8" }}>Email gönderildi!</p>
              <p className="text-sm" style={{ color: "rgba(245,230,200,0.6)" }}>
                Kayıtlı bir hesap varsa yeni şifreniz emailinize gönderildi.
              </p>
              <a href="/auth/giris"
                className="block w-full py-3 rounded-xl font-bold text-sm tracking-widest uppercase text-center mt-4"
                style={{ background: "linear-gradient(135deg, #C89434 0%, #E8B84B 50%, #C8832A 100%)", color: "#0A0705" }}>
                Giriş Yap
              </a>
            </div>
          ) : (
            <>
              <div className="text-center mb-1">
                ...
                <p className="text-xs mt-2" style={{ color: "rgba(245,230,200,0.4)" }}>
                  E-postanızı girin, yeni şifrenizi göndereceğiz.
                </p>
              </div>
              ...
              <button
                ...
                {yukleniyor ? "Gönderiliyor..." : "Yeni Şifre Gönder"}
              </button>
            </>
          )}
        </div>
